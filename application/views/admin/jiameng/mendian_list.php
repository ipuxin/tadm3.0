...
<body>
	<section>
		...
		<form class="tab" action="/mendian/getMendianList">
	...
	<script type="text/javascript">
		...
		var pagejs = {
            ...
            datamodel: [
				{name:"Username",header:"门店商"}, 
				{name:"Account",header:"门店商账号"}, 
				{name:"RealName",header:"联系人"}, 
				{name:"Mobile",header:"联系电话"}, 
				{name:"InvitationCode",header:"邀请码"},
				{name:"IsDisableShow",header:"状态"},
				{value:function(mo){
					var btn = $("<button data-id='"+mo.id+"'>编辑</button>");
					btn.click(function(){
						self.location='/admin/mendian/mendian_upd/'+$(this).data('id');
					});
					return btn;
				},header:"操作"}
			],
