...
<body class="bg-grey">
	<warpbox>
		<tit><span>添加</span> 分类</tit>

		<form class="tab" action="/category/addCate">
			<line>
			...
			<line style="height:200px;">
				<input type="hidden" id="ImageInput" name="ImgUrl" value=''>
			...
			<line>
				...
				<input type="text" data-valids="required" class="valid" name="CateName" value="">
			</line>
			<line>
				<span class="title">分类排序：</span>
				<input type="text" data-valids="number" class="valid" name="CateSorting" value="0">
				<span>(数字越大越靠前)</span>
			</line>
			<line>
