...
<body>
	<section>
		...
		<div class="tab-box" style="margin-bottom:12px;">
			...
			<span class="">快递编号</span>
			<span class="">批量发货</span>
        </div>
		<tabarea>
		...
		<form><line>
		<?foreach($kuaidi as $v){?>
			<span style="float:left;margin-right:10px;"><?=$v['Name']?>---<?=$v['Code']?></span>
		<?}?>
		</line></form>
		</tabarea>
		<tabarea>
		<img style="margin:20px;" src="<?=$staticPath?>images/excel_exp.png">
		<form action="/order/excelRead" method="post" enctype="multipart/form-data">
			<input type="hidden" name="leadExcel" value="true">
			<input type="file" name="inputExcel" value="选择文件">
