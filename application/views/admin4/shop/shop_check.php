...
<body>
	<section>
		<div class="title"><span>店铺审核</span></div>
		<form class="tab" action="/shop/getShopShenheList">
			<input type="hidden" name="IsOpenAdminAccount" value="0">
	...
	<script type="text/javascript">
		...
		var pagejs = {
            ...
            datamodel: [
				{name:"ShopType",header:"申请类型"}, 
				{name:"realname",header:"申请人"}, 
				{name:"mobile",header:"联系手机"}, 
				{value:function(mo){
				...
				{value:function(mo){
					var btn = $("<button data-id='"+mo.id+"'>信息详情</button>");
					btn.click(function(){
						self.location='/admin2/shop/shopshenhe_info/'+$(this).data('id');
					});
					var warp = $('<btns></btns>');
					warp.append(btn);
					return warp;
